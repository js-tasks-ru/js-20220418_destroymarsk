...
export default class ProductForm {
  ...
  getSortableList(images = []) {
    const sortableList = new SortableList({
      items: images.map(({url, source}) => {
        const element = document.createElement('li');
        element.innerHTML = this.getPhotoRowTemplate(url, source);
  ...
  async render() {
    ...
    this.subElements.imageListContainer.append(this.getSortableList(this.images));
